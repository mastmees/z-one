...
; (PATTRN1) or cp/m will HALT.
;
	DEFB	0x09,0x59,0x00,0x00,0x07,0x89	;(* serial number bytes *).
;
;**************************************************************
;*
;*                    B D O S   E N T R Y
...
;
BDOSERR:DEFB	"B","d","o","s"," ","E","r","r"," ","O","n"," "
BDOSDRV:DEFB	" ",":"," ","$"
BADSEC:	DEFB	"B","a","d"," ","S","e","c","t","o","r","$"
BADSEL:	DEFB	"S","e","l","e","c","t","$"
FILERO:	DEFB	"F","i","l","e"," "
DISKRO:	DEFB	"R","/","O","$"
;
...
STARTING: DEFB	0		;starting position for cursor.
...
;**************************************************************
;
EMPTYFCB: DEFB	0xE5		;empty directory segment indicator.
WRTPRT:	DEFW	0		;write protect status for all 16 drives.
LOGIN:	DEFW	0		;drive active word (1 bit per drive).
USERDMA:DEFW	0x80		;user's dma address (defaults to 80h).
;
