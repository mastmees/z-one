...
INBUFF:	DEFB	127		;length of input buffer.
	...
	DEFB	" "," "," "," "," "," "," "," "," "," "," "," "," "," "," "," "
	DEFB	"C","O","P","Y","R","I","G","H","T"
	DEFB	" ","(","C",")"," ","1","9","7","9",","," "
	DEFB	"D","I","G","I","T","A","L"," ","R","E","S","E","A","R","C","H"," "," "
	DS	128-($-INBUFF)+2
...
VERIFY:	LD	DE,PATTRN1	;these are the serial number bytes.
	LD	HL,BDOSSTART	;ditto, but how could they be different?
	LD	B,6		;6 bytes each.
VERIFY1:LD	A,(DE)
	CP	(HL)
...
;
PATTRN1:DEFB	0x09,0x59,0x00,0x00,0x07,0x89 ;(* serial number bytes *).
;
...
RDERROR:LD	BC,RDERR
	JP	PLINE
RDERR:	DEFB	"R","E","A","D"," ","E","R","R","O","R",0
;
;   Required file was not located.
;
NONE:	LD	BC,NOFILE
	JP	PLINE
NOFILE:	DEFB	"N","O"," ","F","I","L","E",0
;
...
RENAME6:LD	BC,EXISTS	;destination file already exists.
	CALL	PLINE
	JP	GETBACK
EXISTS:	DEFB	"F","I","L","E"," ","E","X","I","S","T","S",0
;
;**************************************************************
;*
...
UNKWN0:	LD	BC,BADLOAD	;read error or won't fit.
	CALL	PLINE
	JP	GETBACK
BADLOAD:DEFB	"B","A","D"," ","L","O","A","D",0
COMFILE:DEFB	"C","O","M"	;command file extension.
;
